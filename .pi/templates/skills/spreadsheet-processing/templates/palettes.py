...
Usage:
    ...
    palette = resolve_palette("")  # Chinese prompt example
    # → warm palette
...
_STYLE_KEYWORDS: Dict[str, list[str]] = {
    ...
    "bloomberg": [
        "bloomberg", "", "", "terminal", "", "",
        "rams", "dieter", "", "", "", "bauhaus", "less but better",
        "",
    ],
    "kinfolk": [
        "kinfolk", "", "", "", "", "latte", "",
...
_SCENE_TO_STYLE: Dict[str, str] = {
    ...
    "UI": "creative", "UX": "creative", "": "creative",
    "": "creative", "": "creative",
    ...
    "": "bloomberg", "": "bloomberg", "K": "bloomberg",
