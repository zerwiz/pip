...
- **Gateway Base URL:** `GATEWAY_URL` (e.g., `https://internal-api.PIP`)
...
**Example:**
- Full URL: `https://internal-api.PIP/external/finance/v1/markets/search?search=Apple`
- Breakdown:
  - `https://internal-api.PIP` - Gateway base URL (`GATEWAY_URL`)
