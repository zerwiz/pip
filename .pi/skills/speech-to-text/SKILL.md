---
name: speech-to-text
description: Implement speech-to-text (ASR/automatic speech recognition) capabilities using open-source tools like Whisper. Use this skill when the user needs to transcribe audio files, convert speech to text, build voice input features, or process audio recordings. Supports various audio formats and returns accurate text transcriptions.
license: MIT
---
