...
export default function WorkBoardSelector({
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex items-center gap-4 px-6 pt-4 border-b border-gray-700 flex-shrink-0">
            ...
            >
              My Boards ({filteredBoards.length})
            </button>
            <button
      ...
      {/* Create Empty Board Modal - higher z-index for proper stacking */}
      {showCreateModal && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          <div className="fixed inset-0 bg-black/75 backdrop-blur-sm animate-fade-in" onClick={() => setShowCreateModal(false)} />
          <div className="relative bg-[#1e1e1e] rounded-lg shadow-2xl max-w-md w-full p-6 border border-gray-700 animate-scale-in">
      ...
      {_selectedTemplate && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          <div className="fixed inset-0 bg-black/75 backdrop-blur-sm animate-fade-in" onClick={() => setSelectedTemplate(null)} />
          <div className="relative bg-[#1e1e1e] rounded-lg shadow-2xl max-w-md w-full p-6 border border-gray-700 animate-scale-in">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-[#cccccc]">{_selectedTemplate}</h3>
              <button
            ...
            <div className="text-center py-8">
              <button
                onClick={() => handleCreateFromTemplate(_selectedTemplate)}
                className="px-6 py-2 bg-[#ea580c] hover:bg-[#c2410c] text-[#cccccc] rounded-lg transition-colors"
              >
