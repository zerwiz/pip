...
**不要只搜"AI news today"。** 泛搜索返回的是 SEO 聚合页和趋势predict文章，会系统性遗漏社区级病毒传播现象（如开源工具爆火、Meme 级事件）。必须用多维度、分层搜索策略。

## 工作流程

### 1. 多维度分层搜索（最少 8 次，advice 10-12 次）
...
| 搜索词中加具体年月日 | 用 "this week" "today" "latest" | 日期反而会偏向predict/展望文章 |
