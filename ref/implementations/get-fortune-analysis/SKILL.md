...
* **结构**：
    ...
    4.  **情感/人际**：人际relationship模式与情感走向分析（50-80字）。
...
```json
{
    "fortune_report": {
        ...
        "analysis": {
            ...
            "love": "情感方面，桃花星悄然绽放。单身者极易在学习场所、图书馆或艺术展上邂逅精神契合的伴侣；有伴侣者，今年是进行深度沟通、解决历史遗留问题的破冰之年，relationship将升华到精神层面。"
        }
    }
}```
    ...
    <div class="app-container">
        ...
        <div class="result-layer" id="resultLayer">
            ...
            <div class="detail-card">
                ...
                <div class="star-row"><span>情感relationship Love</span><span class="stars" id="loveStars">★★★★★</span></div>
            </div>
            <div class="detail-card">
            ...
            <div class="detail-card">
                <div class="section-title"><span>♥</span> 情感与advice</div>
